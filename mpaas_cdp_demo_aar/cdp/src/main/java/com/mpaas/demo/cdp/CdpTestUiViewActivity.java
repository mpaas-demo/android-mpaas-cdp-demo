...
public class CdpTestUiViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mpaas.demo.R.layout.mcdp_activity_test_ui_view);
        findViewById(com.mpaas.demo.R.id.cdp_test_ui_view_txt).setBackgroundResource(getMcdpSplashRoundImg());
    }
