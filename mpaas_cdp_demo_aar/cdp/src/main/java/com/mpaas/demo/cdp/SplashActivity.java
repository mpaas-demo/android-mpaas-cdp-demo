...
public class SplashActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mpaas.demo.R.layout.activity_splash);
        findViewById(com.mpaas.demo.R.id.request_start_up_page).setOnClickListener(new View.OnClickListener() {
            @Override
